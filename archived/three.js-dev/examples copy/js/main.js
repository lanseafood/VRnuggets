...
function render() {
  ...
  if(is3pressed) {
    var size = bacteria.scale.x
    if (bacteria.scale.x < 200000) {
      size += 5
      bacteria.scale.set(size);
